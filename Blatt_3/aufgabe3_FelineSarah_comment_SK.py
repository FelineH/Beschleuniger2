...
# COMMENT: Für sowas gibts scipy.constants!
#          -> zB from scipy.constants import c
#define constants
...
# COMMENT: (f) P_s müsste noch mit der Anzahl der Elektronen multipliziert werden!
#computed constants
...
# COMMENT: (f) Weitgehend OKAY. Ihr solltet allerdings den Anteil an der Gesamtstrahlungsleistung P_s berechnen. Ihr habt lediglich den Anteil relativ zur Leistung in P_ges angegeben
...
# COMMENT: (f) Plots sind an sich okay, aber bei der spektralen Leistungsdichte fehlend die Einheiten!
#draw function
...
# WERTUNG
# -------
# a) 1,0/2P: Punktabzug, weil die P_s nicht mit der Anzahl der ELektronen multipliziert worden ist und wegen fehlender Achsenbeschriftung! Sonst okay!
# b) 0,5/1P: Punktabzug für die falsche Referenzleistung. Sonst okay!
